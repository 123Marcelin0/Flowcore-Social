...
export function ClientPageRoot() {
  ...
  // Show the AI tools sidebar for all AI Studio tools.
  // Offset the main content for all tools except the editor, where it should overlay.
  const showAiToolbar = activeSection === "ai-studio"
  const shouldOffsetMain = showAiToolbar && aiStudioState.activeTool !== "video-editor"

  return (
    <DateProvider>
      {/* Simplified neutral background for all sections; removed marble backgrounds */}
      <div className="fixed inset-0 z-0 bg-[#f5f6f7]" />
      ...
      <div className="flex h-screen relative overflow-hidden z-10">
        ...
        {activeSection === "ai-studio" && (
          <div className="absolute inset-0 pointer-events-none">
            ...
            {/* Optional: keep orbs minimal for performance; remove if requested */}
        ...
        <div className="relative z-10 flex w-full">
          ...
          {showAiToolbar && (
            <div className="absolute left-0 top-0 bottom-0 z-[300000]">
              <AIStudioToolbar 
          ...
          {/* Main Content Area */}
          <main className={`flex-1 overflow-y-auto relative z-20 ${shouldOffsetMain ? "scrollbar-thin ml-72" : ""}`}>
