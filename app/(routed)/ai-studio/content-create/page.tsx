...
import { ContentGallery } from "@/app/components/content-gallery"
import { AIStudioToolbar } from "@/app/components/ai-studio-toolbar"

export default function ContentCreateToolPage() {
	return (
		<ProtectedRoute fallback={<LoginPage />}>
			<div className="relative flex w-full">
				<div className="absolute left-0 top-0 bottom-0 z-40">
					<AIStudioToolbar onBack={() => history.back()} activeTool="content-create" />
				</div>
