  ...
  groups: [
    ...
    },
    {
      ...
      routes: [
        ...
        { path: "/ai-studio/video-editor", title: "Video Editor", icon: "Edit3", component: "@/app/components/ai-studio-video-editor", toolId: "video-editor" },
    ...
    },
    {
      ...
      title: "Demos & Labs",
      routes: [
        { path: "/glassmorphic-workflow", title: "Glassmorphic Workflow", icon: "BezierCurve", component: "@/components/glassmorphic-workflow-canvas" },
