-- Migration 02: Unified Time-Series Metrics & Centralized Embeddings (FIXED VERSION v2)
-- This version fixes the policy creation syntax error
...
-- ==========================================
-- 8. CREATE RLS POLICIES (FIXED SYNTAX)
-- ==========================================
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can view all metrics" ON time_series_metrics;
    CREATE POLICY "Users can view all metrics" ON time_series_metrics
        FOR SELECT USING (true);

    DROP POLICY IF EXISTS "Users can insert metrics" ON time_series_metrics;
    CREATE POLICY "Users can insert metrics" ON time_series_metrics
        FOR INSERT WITH CHECK (true);

    -- Embeddings policies
    DROP POLICY IF EXISTS "Users can view all embeddings" ON embeddings;
    CREATE POLICY "Users can view all embeddings" ON embeddings
        FOR SELECT USING (true);
